...
class TaglibLoader {
    ...
    "*"(name, value) {
        ...
        if (name.startsWith("<")) {
            ...
            var attr = loaders.loadAttributeFromProps(attrKey, value, this.dependencyChain.append("@" + attrKey));
    ...
    attributes(value) {
        ...
        Object.keys(value).forEach(attrName => {
            ...
            var attr = loaders.loadAttributeFromProps(attrName, attrDef, this.dependencyChain.append("@" + attrName));
    ...
    attributeGroups(value) {
        ...
        Object.keys(value).forEach(attrGroupName => {
            ...
            Object.keys(rawAttrGroup).forEach(attrName => {
                ...
                let attr = loaders.loadAttributeFromProps(attrName, rawAttrDef, attrGroupDependencyChain.append("@" + attrName));
