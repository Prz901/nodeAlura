...
class TagLoader {
    ...
    "*"(name, value) {
        ...
        if (value != null && typeof value === "object") {
            for (k in value) {
                if (value.hasOwnProperty(k)) {
                    if (k.startsWith("@") || k.startsWith("<")) {
                        ...
                        if (isSupportedProperty(propNameDashes) && loaders.isSupportedAttributeProperty(propNameDashes)) {
            ...
            if (!isObjectEmpty(value)) {
                throw new Error("Unsupported properties of [" + Object.keys(value).join(", ") + "]");
            }
        ...
        for (i = 0; i < parts.length; i++) {
            ...
            if (part.startsWith("@")) {
                ...
                var attr = loaders.loadAttributeFromProps(attrName, attrProps, dependencyChain.append(part));
                ...
                if (!nestedTag.isRepeated) {
                    let attr = loaders.loadAttributeFromProps(nestedTag.targetProperty, { type: "object" }, dependencyChain.append(part));
    ...
    nestedTags(value) {
        ...
        forEachEntry(value, (nestedTagName, nestedTagDef) => {
            ...
            if (!nestedTag.isRepeated) {
                let attr = loaders.loadAttributeFromProps(nestedTag.targetProperty, { type: "object" }, dependencyChain);
