...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, ownerComponent, childCount, flags, props) {
        var child = this.bj_(new VElement(tagName, attrs, key, ownerComponent, childCount, flags, props));
    ...
    n: function (node, ownerComponent) {
        node = node.__();
        node.bk_ = ownerComponent;
        this.bj_(node);
        return this.bE_();
    },

    bq_: function (doc, parentNamespaceURI) {
        var tagName = this.bB_;
...
VElement.bH_ = virtualizeElement;

VElement.bI_ = function (fromEl, vFromEl, toEl) {
    var removePreservedAttributes = VElement.bG_;
