...
var delegateEvent = eventDelegation._U_;
var getEventFromEl = eventDelegation._V_;
...
function handleNodeAttach(node, componentsContext) {
    if (node.nodeType === 1) {
        ...
        if (target) {
            ...
            var attachTargets = data._W_;
            if (!attachTargets) {
                attachTargets = data._W_ = [];
                out.on("_N_", function () {
...
eventDelegation._X_ = handleNodeAttach;
