...
module.exports = function defineRenderer(renderingLogic) {
    ...
    if (!renderer) {
        ...
        renderer = function renderer(input, out) {
            ...
            var isReceivingNewInput = !component || component.am_;
            var parentComponentDef;

            if (component) {
                delete component.am_;
            }
            ...
            if (!component && componentLookup) {
                if (parentComponentDef = componentsContext.j_) {
                    var key = out.an_;
            ...
            if (isReceivingNewInput) {
                ...
                widgetBody = component.ao_;
                widgetState = component._t_;
