    ...
    out.onLast(function (next) {
        ...
        function handleAwait(awaitInfo) {
            awaitInfo.out.on("finish", function (result) {
                ...
                asyncOut.write('<div id="af' + awaitInfo.id + '" style="display:none">' + result.toString() + "</div>" + '<script type="text/javascript">$af(' + (typeof awaitInfo.id === "number" ? awaitInfo.id : '"' + awaitInfo.id + '"') + (awaitInfo.after ? ',"' + awaitInfo.after + '"' : "") + ")</script>");
