...
class Normalizer {
    ...
    normalizeElement(elNode) {
        ...
        var newNode = context.createNodeForEl({
            tagName: elNode.rawTagNameExpression ? builder.parseExpression(elNode.rawTagNameExpression) : context.ignoreUnrecognizedTags && !elNode.parentNode.tagDef ? elNode.tagName.replace(/^@/, "at_") // escapes @tags inside unrecognized tags
            : elNode.tagName,
        ...
        if (elNode.params.length && elNode.tagName !== "for" && elNode.tagName !== "macro" && !context.isMacro(elNode.tagName) && !((elNode.tagName === "@then" || elNode.tagName === "@catch") && elNode.parentNode.tagName === "await")) {
