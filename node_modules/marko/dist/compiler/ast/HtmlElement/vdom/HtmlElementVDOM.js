        ...
        if (attributes != null && attributes.length !== 0) {
            ...
            attributes.forEach((attr, i) => {
                if (attr.spread) {
                    ...
                    attrs.push(codegen.builder.functionCall(context.helper("attrs"), [attr.value]));
                    explicitAttrs = null;
            ...
            attributesArg = attrs.length > 1 ? builder.functionCall(context.helper("assign"), attrs) : attrs[0];
        }

        if (!this.isAttrsStatic && hasNamedAttributes && hasSimpleAttrs && !hasSpreadAttributes) {
