...
function isWhiteSpaceTextNode(node) {
    return node.type === "Text" && node.argument.type === "Literal" && /^\s+$/.test(node.argument.value);
}
    ...
    generateRenderNode(codegen, tagDef, inputProps, parentCustomTag) {
        ...
        if (tagDef.template) {
            ...
            if (isNestedTag) {
                ...
                const argumentNode = this.argument ? builder.arrayExpression(builder.parseJavaScriptArgs(this.argument)) : builder.literalNull();
                const properties = this.getProperties();
                tagVar = context.helper("dynamicTag");
                tagArgs = [builder.identifierOut(), this.tagNameExpression, inputProps, argumentNode, properties ? builder.objectExpression(Object.keys(properties).map(propName => {
